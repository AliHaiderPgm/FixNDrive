...
const Sample_7 = () => {
    return (
        <div className="rounded-md shadow-lg h-full relative flex flex-col items-center" style={{ background: "radial-gradient(circle, rgba(62,128,211,1) 0%, rgba(1,40,90,1) 100%)" }}>
            <img src={banner7} alt="banner" className="max-w-full h-auto" />
            <div className="flex flex-col items-center text-white p-4 absolute top-1/2 md:top-2/3">
